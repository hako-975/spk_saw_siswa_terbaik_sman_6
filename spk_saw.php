...
<head>
    ...
    <title>SPK SAW Siswa Terbaik SMAN 6 - SPK SAW</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">SPK SAW</h1>
                    </div>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="card">
                                <div class="card-body">
                                    <a href="tambah_spk_saw.php" class="btn btn-primary mb-3"><i class="fas fa-fw fa-plus"></i> Tambah SPK SAW</a>
                                            ...
                                            <tbody>
                                                ...
                                                <?php foreach ($hasil_saw as $dk): ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $dk['nama_siswa']; ?></td>
                                                        <td><?= $dk['kelas']; ?></td>
                                                        <td><?= $dk['nilai_preferensi_tertinggi']; ?></td>
