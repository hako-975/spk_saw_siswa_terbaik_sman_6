...
<body id="page-top">
    ...
    <?php
        if (isset($_POST['btnTambahUser'])) {
            ...
            $insert_user = mysqli_query($conn, "INSERT INTO user VALUES ('', '$username', '$password_hash', '$nama', '$jabatan', CURRENT_TIMESTAMP())");
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form method="post">
                                        ...
                                        <button type="submit" name="btnTambahUser" class="btn btn-primary">Tambah User</button>
                                    </form>
                                </div>
                            </div>
                        </div>
